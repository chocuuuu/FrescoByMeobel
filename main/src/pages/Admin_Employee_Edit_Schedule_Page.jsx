    ...
    const fetchScheduleData = async () => {
      try {
        ...
        if (!response.ok || (await response.json()).length === 0) {
          console.log(
            `No schedule found with user_id=${userId}, trying with employeeId=${employeeId}`
          );
          response = await fetch(
            `${API_BASE_URL}/schedule/?user_id=${employeeId}`,
            {
              headers: {
                Authorization: `Bearer ${accessToken}`,
                "Content-Type": "application/json",
              ...
              try {
                ...
                if (shiftResponse.ok) {
                  ...
                  if (startTime === "10:00:00" && endTime === "19:00:00") {
                    ...
                    setCustomShiftStart(
                      convertTimeFormatToTimeString(startTime)
                    );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 pt-4 pb-8 flex flex-col gap-6 mt-16">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-[#5C7346] rounded-lg p-6 lg:w-2/3 lg:h-[calc(100vh-180px)] lg:overflow-auto">
          ...
          {/* Employee Schedule Panel - Scrollable if needed */}
          <div className="bg-[#3A4D2B] rounded-lg p-4 lg:w-1/3 lg:h-[calc(100vh-180px)] lg:overflow-auto flex flex-col">

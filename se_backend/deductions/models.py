...
class Deductions(models.Model):
    ...
    sss = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    philhealth = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    pagibig = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
